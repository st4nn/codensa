...
if($userfile3<>"")
{
 ...
 // echo $de;
  ...
  {
    $M="Archivo superior al tamaño permitido de 200K.";
   }*/
 //echo $M;
 if($M=="Archivo copiado")
 {
  if(file_exists($rutadestino))
  {
	 ...
	 // echo $sql2;
      $q->ejecutar($sql2,345,'GuardarFotoPC.php');	  
  
  } //el earchivo existe
 }  //la m esta en blanco

   $q->ejecutar("INSERT INTO[LOG] (US_USUARIO, MODULO, FECHA, ACCION) 
   				VALUES('$usr', 'ModInspeccion',GETDATE(), '$GE_NO_INSPECCION GuardarFotoPC.php' )", 85, "GuardarFotoPC.php");
