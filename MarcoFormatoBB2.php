...
<head>
  ...
  <link href="css/MarcoFormatoBB.css" rel="stylesheet" type="text/css" />
    ...
    <td><table width="100%" height="107" border="0">
      ...
      <tr>
		...
		if($GE_NO_INSPECCION<>"")
		 {?>
          <!--
              <td class="TituloGrande"><div align="left"><a href="#" onclick="PrimeraParte('FormatoBB2.php')"><img src="Img/flecha1.jpg" width="19" height="19"    border=""/>1.General</a></div></td>
      ...
      <tr>
        <td width="45%"  class="titulosFondoGris"><span class="titulosRojoGrande">No Inspeccion</span> </td>
        <td width="50%" class="titulosFondoGris"><form  name="form1" action="" method="get">
...
if($GE_NO_INSPECCION<>"")
     {?>
              <div data-role="navbar">
                <ul>
                  <li><a href="#" onclick="PrimeraParte('FormatoBB2.php')">1.General</a></li>
                  <li><a href="#" onclick="PrimeraParte('CuadrillaBB.php')">2. Cuadrillas</a></li>
                  <li><a href="#" onclick="PrimeraParte('EvalListadoNCBB.php')">3. Evaluacion</a></li>
                  <li><a href="#" onclick="PrimeraParte('FotosVideoBB.php')" >4. Fotos y videos</a></li>
                  <li><a href="#" onclick="PrimeraParte('Cierre2.php')" >5. Observaciones y cierre </a></li>
                </ul>
              </div>
            <?
    }  //if si existe no de inspeccion 
