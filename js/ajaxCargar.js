...
function ListarSubBB(CL_ID, SBID, GENOINSPECCION) {
...
function cargarSubclasificaicon(Idclasificacion,idSelectOrigen, BanBB)
{  
...
if(opcionSeleccionada==0)
        ...
        else if(idSelectOrigen!=listadoSelects[listadoSelects.length-1])
        {
				...
				if(BanBB=='Admin')
				{
					 ajax.open("GET", "AdminSubclasificaicon.php?CL_ID="+Idclasificacion+"&BanBB="+BanBB, true);
				}
				else
				{
				 ajax.open("GET", "obtenerSubclasificaicon.php?CL_ID="+Idclasificacion+"&BanBB="+BanBB, true);
				}
